        ...
        {loading ? (
          ...
          <>
            ...
            <Banner
              ...
              name={`Caps & Scarves`}
              subtitle={
                'Look to our Caps & Scarves for modern takes on one-and-done dressing. From midis in bold prints to dramatic floor-sweeping styles and easy all-in-ones, our edit covers every mood.'
              }
            />
            <Container size={'large'} spacing={'min'}>

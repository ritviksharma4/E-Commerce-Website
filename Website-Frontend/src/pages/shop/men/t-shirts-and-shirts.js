...
const TShirtsShirtsMenPage = () => {
  ...
  const fetchProducts = useCallback(async () => {
    const savedProducts = sessionStorage.getItem('tShirtsShirtsMen_products');
    const savedTotalCount = sessionStorage.getItem('tShirtsShirtsMen_totalCount');
    ...
    try {
      ...
      sessionStorage.setItem('tShirtsShirtsMen_products', JSON.stringify(items));
      sessionStorage.setItem('tShirtsShirtsMen_totalCount', items.length.toString());

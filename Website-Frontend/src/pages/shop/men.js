...
const AllClothingsMenPage = () => {
  ...
  const fetchProducts = useCallback(async () => {
    const savedProducts = sessionStorage.getItem('all_men_products');
    const savedTotalCount = sessionStorage.getItem('all_men_totalCount');
    ...
    try {
      ...
      sessionStorage.setItem('all_men_products', JSON.stringify(items));
      sessionStorage.setItem('all_men_totalCount', items.length.toString());

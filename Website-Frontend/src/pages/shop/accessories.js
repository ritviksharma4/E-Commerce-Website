...
const AllAccessoriesPage = () => {
  ...
  const [savedFilters, setSavedFilters] = useState(() => {
    const storageKey = "velvet_login_key.filters.accessories.allAccessories";
  ...
  const getLoadedItemCount = () => {
    return parseInt(sessionStorage.getItem('all_accessories_loadedItemCount')) || ITEMS_PER_PAGE;
  };
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(LAMBDA_ENDPOINT, {
        ...
        body: JSON.stringify({ email, category: 'accessories' }),
      });
  ...
  const handleLoadMore = () => {
    ...
    sessionStorage.setItem('all_accessories_loadedItemCount', newCount);
  };
  ...
  const handleRemoveFilter = (filterCategory, filterName) => {  
    const storageKeySimple = "velvet_login_key.filters.accessories.allAccessories";
    ...
    const detailedFilters = userObj.filters?.accessories?.allAccessories || [];
    ...
    userObj.filters.accessories.allAccessories = detailedFilters;
          ...
          <>
            <Container size={'large'} spacing={'min'}>
              <div className={styles.breadcrumbContainer}>
                <Breadcrumbs
                  crumbs={[{ link: '/', label: 'Home' }, { link: '/shop/accessories', label: 'Accessories' }, { label: 'All Accessories' }]}
                />
              </div>
            </Container>
            <Banner
              ...
              subtitle={
                "Elevate your style with our curated collection of accessories—featuring chic caps, elegant scarves, dazzling earrings, trendy bracelets and stylish bags for every occasion."
              }
            />
            <Container size={'large'} spacing={'min'}>

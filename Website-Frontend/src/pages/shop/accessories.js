...
const AllAccessoriesPage = () => {
  ...
  const restoreScroll = () => {
    const scrollY = sessionStorage.getItem('accessories_scrollY');
    if (scrollY) {
  ...
  useEffect(() => {
    const storeScroll = () => {
      sessionStorage.setItem('accessories_scrollY', window.scrollY.toString());
    };
        ...
        {loading || filtering ? (
          ...
          <>
            ...
            <Banner
              ...
              subtitle={
                'Elevate your style with our curated collection of accessories—featuring chic caps, elegant scarves, dazzling earrings, trendy bracelets, stylish bags, and captivating perfumes for every occasion.'
              }
            />
            <Container size={'large'} spacing={'min'}>

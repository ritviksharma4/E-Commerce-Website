...
const AllAccessoriesPage = () => {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      const savedIndex = parseInt(sessionStorage.getItem('accessories_loadedItemCount')) || ITEMS_PER_PAGE;
  ...
  const handleLoadMore = () => {
    ...
    sessionStorage.setItem('accessories_loadedItemCount', newCount);
  };

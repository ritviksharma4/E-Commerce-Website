  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(LAMBDA_ENDPOINT, {
        ...
        body: JSON.stringify({ email, category: 'footwear', subCategory: 'heels-and-sandals' }),
      });
      ...
      console.error('Error fetching heels-and-sandals from Lambda:', error);
    } finally {
      setLoading(false);
    }
  }, [LAMBDA_ENDPOINT]);
          ...
          <>
            <Container size={'large'} spacing={'min'}>
              <div className={styles.breadcrumbContainer}>
                <Breadcrumbs
                  crumbs={[{ link: '/', label: 'Home' }, { link: '/shop/footwear', label: 'Footwear' }, { label: 'Heels & Sandals' }]}
                />
              </div>
            </Container>
            <Banner

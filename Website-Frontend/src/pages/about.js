  ...
  const useScrollToHash = (sectionsMap, desktopOffset = 0) => {
    useEffect(() => {
      if (typeof window !== 'undefined') {
        ...
        if (hash && sectionsMap[hash] && sectionsMap[hash].current) {
          const element = sectionsMap[hash].current;
  
          // Check if viewport is mobile size (max 900px)
      ...
      <div className={styles.root}>
          ...
          <div className={styles.detailContainer} ref={historyRef}>
            ...
            <div className={styles.historyTextContainer}>
              ...
              <p>
                ...
                that makes T-shirts in its own factory in India. And we do this
        ...
        <Container size={'large'} spacing={'min'}>
          <div className={styles.content}>
            ...
            <div ref={valuesRef}>
              <p>
                Velvét produced some of the world's earliest T-shirts. In the
            ...
            <div id={'sustainability'} ref={sustainabilityRef}>
              <p>
                Our founder, Ritvik Sharma, had both an eye for quality and a
                desire to innovate. As well as using the finest fibres such as
                Sea Island cotton, cashmere and silk, he invented his own
                fabrics. Velvét continues this commitment to innovation today
                ...
                unchanged today and all Velvét products use the finest cottons,
                wools and fibres.
              </p>
              <p>
                Made in Ahmedabad, India and crafted from our luxurious long
                staple Supima cotton for unparalleled softness, comfort and
                durability, the Velvét T-shirt has a classic fit and only the
                most essential details.{' '}
              </p>
              <p>
                With over 100 years spent perfecting fabric, fit and style, the
                Velvét Classic T-shirt is recognised as the finest in the
                world.
              </p>
            </div>
          </div>
